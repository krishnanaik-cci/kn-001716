...
function startAnimation() {
	...
	.to([getElem("lybalvi-logo")], speed, {autoAlpha:1, delay:2, scale:.89, x:1, y:-68}, "frame1")
	...
	.to(getElem("victoria-img"), speed, {x:-300}, "frame3")
	.to([getElem("text-one"), getElem("copper-bar"), getElem("text-three")], speed, {autoAlpha:0, x:-300}, "frame3")
